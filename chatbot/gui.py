...
# Menu bar
    ...
    # Options
        ...
        help_option.add_command(label="About KISAANmithra", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("About KISAANmithra :",'KISAANmithra is a chatbot for answering farmers queries\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer questions regarding plantation,irrigation,seed price,pesticides,weed remooval methods,fertilizers,agricultural loans etc.')

    def about(self):
        tkinter.messagebox.showinfo("KISAANmithra Developers","1.CHETHAN S\n2.PRAJWAL K\n3.VINAYKUMAR MOGER")
...
root.title("KISAANmithra...")
root.iconbitmap('kisaaanmithraicon.ico')
root.mainloop()
